...
function PartnerComponent(props) {
  ...
  const tooltip =(val)=> (
    <Tooltip id="tooltip">{val}</Tooltip>
  );
  ...
  return (
    <Container fluid>
      ...
      <Row>
          <Breadcrumb>
            <Breadcrumb.Item href="/" style={{ fontWeight: "bold" }}><BiHome/>Home</Breadcrumb.Item><span> &nbsp;{">"}</span>
            { props.isCreatedModule ? (
              <Breadcrumb.Item active style={{ fontWeight: "bold" }}>&nbsp;Create Partner</Breadcrumb.Item>
            ):(
              <Breadcrumb.Item active style={{ fontWeight: "bold" }}>&nbsp;Update Partner</Breadcrumb.Item>
            )}
          </Breadcrumb>
      </Row>
      <Row>
        ...
        <Container fluid>
          <Form noValidate onSubmit={handleSubmit(onSubmit, onError)}>
            <Row>
              <Card className="cardPanel">
                <Form.Group className="mb-4">
                  <Row>
                    <Col>
                      <Form.Label size="sm" htmlFor="partner_name">Partner Name</Form.Label>&nbsp;
                      <OverlayTrigger placement="right" overlay={tooltip('Enter the Account Name to create new partner.')}>
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="country">Country</Form.Label>
                      <Form.Select size="sm"
                        id="country"
                        name="country"
                        {...register("country", {
                    ...
                    <Col>
                    <Form.Label size="sm" htmlFor="partnerGroup">Partner Group</Form.Label>
                    <Form.Select size="sm"
                        id="partnerGroup"
                        name="partnerGroup"
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="electricEntity">Schneider Electric Entity</Form.Label>
                      <Form.Select size="sm"
                        id="electricEntity"
                        name="electricEntity"
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="marketplcseller">Marketplace Seller</Form.Label>
                      <Form.Select size="sm"
                        id="marketplcseller"
                ...
                <Form.Group className="mb-4">
                  <Row>
                    <Col>
                      <Form.Label size="sm" htmlFor="marketplcseller">Partner ID</Form.Label>
                      <Form.Control size="sm"
                            id="partner_id"
                            name="partner_id"
                            disabled
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="business_type">Business Type</Form.Label>
                      <Form.Select size="sm"
                        id="business_type"
                        name="business_type"
                        //onChange={(e) => onChangeHandler(e)}
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="model_type">Model Type</Form.Label>
                      <Form.Select size="sm"
                        id="model_type"
                        name="model_type"
                        // onChange={(e) => onChangeHandler(e)} 
                ...
                <Form.Group className="mb-4">
                  ...
                  <Col>
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="playbook_type">E2 Playbook Type</Form.Label>
                      <Form.Select size="sm"
                        id="playbook_type"
                        name="playbook_type"
                    ...
                    <Col>
                      <Form.Label size="sm" htmlFor="bopp_type">Bopp Type</Form.Label>
                      <Form.Select size="sm"
                        id="bopp_type"
                        name="bopp_type"
                        {...register("bopp_type", {
                ...
                <Form.Group className="mb-4">
                  <Row>
                    <Col>
                        <Form.Label size="sm" htmlFor="gtm_type">GTM Type</Form.Label>
                        <Form.Select size="sm" className="fieldProp"
                          id="gtm_type"
                          name="gtm_type"
                          {...register("gtm_type", {
            ...
            <Form.Group className="mb-4">
                <Row>
                  <Col>
                    <Form.Label size="sm" htmlFor="editor">Editor</Form.Label>&nbsp;
                    <Form.Control size="sm"
                      id="editor"
                      name="editor"
                      disabled={ !props.isCreatedModule }
                  ...
                  <Col>
                    <Form.Label size="sm" htmlFor="backupEditor">Backup Editor</Form.Label>&nbsp;
                    <Form.Control size="sm"
                      id="editor"
                      name="editor"
                      disabled={ !props.isCreatedModule }
                  ...
                  <Col>
                    <Form.Label size="sm" htmlFor="approver1">Approver 1</Form.Label>
                    <Form.Control size="sm"
                        id="approver1"
                        name="approver1"
                        disabled={ !props.isCreatedModule }
                  ...
                  <Col>
                  <Form.Label size="sm" htmlFor="approver2">Approver 2</Form.Label>
                    <Form.Control size="sm"
                        id="approver2"
                        name="approver2"
                        disabled={ !props.isCreatedModule }
            ...
            <Form.Group className="mb-1">
              <Row className="justify-content-end">
                <Col md={1}>
                  <Button variant="secondary" className="btn btn-cancel">
                    Cancel
                  </Button>
                </Col>
                <Col md={2}>
